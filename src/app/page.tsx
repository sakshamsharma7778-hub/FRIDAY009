  ...
  return (
    ...
    >
        ...
        {chat.map((item, index) => (
          <div
            ...
            style={{
              ...
              background: item.role === "user" ? "#1f6feb" : "#222",
              padding: "12px 14px",
              borderRadius: "14px",
              maxWidth: "80%",
              lineHeight: "1.4",
      ...
      >
        ...
        <button onClick={startVoice} style={{ padding: "12px" }}>
          🎤
        </button>

        <button onClick={() => sendToFriday(message)} style={{ padding: "12px" }}>
          Send
        </button>
      </div>
